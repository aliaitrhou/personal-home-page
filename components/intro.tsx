...
function DesignEngineerMark() {
  return (
    <svg
      ...
      aria-hidden="true"
      focusable="false"
      className="home-design-mark mr-1"
    >
      <g
        fill="none"
        strokeLinecap="round"
...
export function Intro() {
  return (
    <div className={`${saira.className} font-thin`}>
      <p className="text-sm leading-relaxed leading-6">
        I’m Ali, a computer science student
        <br /> and a{" "}
        <DesignEngineerPhrase>Software developer </DesignEngineerPhrase>Based in
        Morocco. <br />
        and I love getting the{" "}
        <DetailsPhrase>
      ...
      <p className="mt-3 text-sm leading-relaxed text-muted-foreground leading-6">
        I spend my time identifying problems worth solving, then designing and
